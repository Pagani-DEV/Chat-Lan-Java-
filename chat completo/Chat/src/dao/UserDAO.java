...
public class UserDAO {
    ...
    public boolean verificaLoginExiste(User user) {
        ...
        try {
            String SQL = "SELECT 1 FROM user WHERE login = ?";
            connL = this.conn;
    ...
    public void inserir(User user) {
        ...
        if(verificaLoginExiste(user)) {
            JOptionPane.showMessageDialog(null, "Este login já foi cadastrado!");
        } else {
            try {
